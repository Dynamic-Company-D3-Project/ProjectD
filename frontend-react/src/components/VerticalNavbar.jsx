...
const VerticalNavbar = ({ onSelectCategory }) => {
  const categories = [
    ...
    { id: 8, name: "Beauty Services" },
    { id: 9, name: "Fitness" },
    { id: 10, name: "Home Painting" },
  ];
  ...
  return (
    <div>
      <aside
        id="sidebar"
        class="fixed relative mt-6 z-40 w-64 transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
